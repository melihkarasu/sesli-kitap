# 🎧 Sesli Kütüphane (LibriVox)

LibriVox açık kamu malı arşivi ile dünya edebiyatı klasiklerinin seslendirilmiş kayıtları ve ses çaları.
...
- **API Source:** LibriVox / Open Audio API
